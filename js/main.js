...
if (bounceText && bounceImg) {
    ...
    function showBounceText(word) {
        ...
        bounceText.style.opacity = 1;
        bounceText.classList.remove('bounce-text-animate');
        void bounceText.offsetWidth; // force reflow
        bounceText.classList.add('bounce-text-animate');
    }
    showBounceText(bounceWords[0]); // Show first word immediately
    setInterval(function() {
        showBounceText(bounceWords[idx]);
        idx = (idx + 1) % bounceWords.length;
    }, 4000);
}